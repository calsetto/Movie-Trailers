...
<div class="container my-2 d-flex justify-content-start">
    ...
    <div class="row justify-content-md-start">
        ...
        <a href="{{url('movieAdmin/'.$item->id.'/edit')}}">
          ...
          <form method="POST" action="{{url('movieAdmin/'.$item->id)}}"class="">

            @method('DELETE')
            @csrf

            <div class="form-group col text-center">
              <button type="submit"class="btn btn-danger text-light btn-block">Delete Movie</button>
            </div>
